...
VALUES 
('Mercedes-Benz', 'SL-Class', 2017, 'available'),
('Acura', 'NSX', 2007, 'available'),
('Chevrolet', 'G-Series 3500', 2014, 'rented'),
('Mercedes-Benz', 'S-Class', 2015, 'available'),
('Chevrolet', 'Camaro', 2015, 'available'),
('Suzuki', 'Daewoo Magnus', 1994, 'available'),
('Ferrari', 'F430', 1992, 'rented'),
('Dodge', 'Ram Van 1500', 1997, 'available'),
('Buick', 'Century', 2002, 'available'),
('Mitsubishi', 'Starion', 1998, 'rented'),
('Honda', 'Element', 2005, 'rented'),
('Pontiac', 'Grand Prix', 2013, 'available'),
('Chevrolet', 'Cavalier', 2016, 'available'),
('Buick', 'Park Avenue', 2010, 'available'),
('Mitsubishi', 'Pajero', 2021, 'available'),
('Nissan', 'Frontier', 1993, 'available'),
('Ford', 'Econoline E350', 2019, 'rented'),
('Ford', 'Crown Victoria', 2004, 'rented'),
('Lexus', 'GX', 2003, 'rented'),
('Acura', 'Integra', 2012, 'available'),
('Ford', 'Crown Victoria', 2015, 'rented'),
('GMC', 'Envoy', 2008, 'available'),
('Volkswagen', 'New Beetle', 2018, 'rented'),
('Pontiac', 'Aztek', 1993, 'rented'),
('Buick', 'Park Avenue', 2025, 'available'),
('Chevrolet', 'Tahoe', 2010, 'available'),
('Nissan', 'Xterra', 2013, 'rented'),
('BMW', '760', 2002, 'available'),
('Lincoln', 'Town Car', 1997, 'available'),
('Saab', '9000', 1995, 'available'),
('Toyota', 'Celica', 2010, 'available'),
('Volkswagen', 'New Beetle', 2005, 'rented'),
('Volvo', '940', 2024, 'available'),
('Pontiac', 'Solstice', 2001, 'rented'),
('Pontiac', 'Bonneville', 1999, 'available'),
('Nissan', 'Sentra', 2019, 'available'),
('Kia', 'Optima', 2005, 'available'),
('Chevrolet', 'Corvette', 2016, 'available'),
('Dodge', 'Neon', 2021, 'available'),
('Pontiac', 'Sunfire', 2005, 'available'),
('Dodge', 'Charger', 1997, 'rented'),
('Lexus', 'IS', 2008, 'available'),
('GMC', 'Suburban 2500', 2010, 'available'),
('Toyota', 'Camry', 2020, 'available'),
('Honda', 'Civic', 2018, 'rented'),
('Ford', 'Mustang', 2022, 'available'),
('BMW', 'X5', 2019, 'rented'),
('Audi', 'A4', 2021, 'available'),
('Tesla', 'Model 3', 2023, 'available'),
('Hyundai', 'Tucson', 2020, 'rented');
