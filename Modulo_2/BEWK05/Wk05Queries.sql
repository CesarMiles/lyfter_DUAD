...
VALUES 
(1, 'Mercedes-Benz', 'SL-Class', 2017, 'available'),
(2, 'Acura', 'NSX', 2007, 'available'),
(3, 'Chevrolet', 'G-Series 3500', 2014, 'rented'),
(4, 'Mercedes-Benz', 'S-Class', 2015, 'available'),
(5, 'Chevrolet', 'Camaro', 2015, 'available'),
(6, 'Suzuki', 'Daewoo Magnus', 1994, 'available'),
(7, 'Ferrari', 'F430', 1992, 'rented'),
(8, 'Dodge', 'Ram Van 1500', 1997, 'available'),
(9, 'Buick', 'Century', 2002, 'available'),
(10, 'Mitsubishi', 'Starion', 1998, 'rented'),
(11, 'Honda', 'Element', 2005, 'rented'),
(12, 'Pontiac', 'Grand Prix', 2013, 'available'),
(13, 'Chevrolet', 'Cavalier', 2016, 'available'),
(14, 'Buick', 'Park Avenue', 2010, 'available'),
(15, 'Mitsubishi', 'Pajero', 2021, 'available'),
(16, 'Nissan', 'Frontier', 1993, 'available'),
(17, 'Ford', 'Econoline E350', 2019, 'rented'),
(18, 'Ford', 'Crown Victoria', 2004, 'rented'),
(19, 'Lexus', 'GX', 2003, 'rented'),
(20, 'Acura', 'Integra', 2012, 'available'),
(21, 'Ford', 'Crown Victoria', 2015, 'rented'),
(22, 'GMC', 'Envoy', 2008, 'available'),
(23, 'Volkswagen', 'New Beetle', 2018, 'rented'),
(24, 'Pontiac', 'Aztek', 1993, 'rented'),
(25, 'Buick', 'Park Avenue', 2025, 'available'),
(26, 'Chevrolet', 'Tahoe', 2010, 'available'),
(27, 'Nissan', 'Xterra', 2013, 'rented'),
(28, 'BMW', '760', 2002, 'available'),
(29, 'Lincoln', 'Town Car', 1997, 'available'),
(30, 'Saab', '9000', 1995, 'available'),
(31, 'Toyota', 'Celica', 2010, 'available'),
(32, 'Volkswagen', 'New Beetle', 2005, 'rented'),
(33, 'Volvo', '940', 2024, 'available'),
(34, 'Pontiac', 'Solstice', 2001, 'rented'),
(35, 'Pontiac', 'Bonneville', 1999, 'available'),
(36, 'Nissan', 'Sentra', 2019, 'available'),
(37, 'Kia', 'Optima', 2005, 'available'),
(38, 'Chevrolet', 'Corvette', 2016, 'available'),
(39, 'Dodge', 'Neon', 2021, 'available'),
(40, 'Pontiac', 'Sunfire', 2005, 'available'),
(41, 'Dodge', 'Charger', 1997, 'rented'),
(42, 'Lexus', 'IS', 2008, 'available'),
(43, 'GMC', 'Suburban 2500', 2010, 'available'),
